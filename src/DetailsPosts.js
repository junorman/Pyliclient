  ...
  <div class="row  mb-3">
          <div class="col-sm-2">
            ...
            <div class="sidebar">
              ...
              {/* Sidebar Menu */}
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-font">
                  {/* Add icons to the links using the .nav-icon class
                       with font-awesome or any other icon font library */}
                  <li class="nav-item menu-open">
                    <a href="#" class="nav-link active" style={{backgroundColor:'#fc841c', fontSize: '14px'}}>
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-font">
                  {/* Add icons to the links using the .nav-icon class
                       with font-awesome or any other icon font library */}
                  <li class="nav-item menu-open">
                    <a href="#" class="nav-link active nav-font" style={{backgroundColor:'#fc841c', fontSize: '14px'}}>
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-font">
                  {/* Add icons to the links using the .nav-icon class
                       with font-awesome or any other icon font library */}
                  <li class="nav-item menu-open">
                    <a href="rechercher_posts.html" class="nav-link active nav-font" style={{backgroundColor:'#fc841c', fontSize: '14px'}}>
          ...
          <div class="col-sm-10">
                  ...
                  <form class="form-horizontal">
                    <div class="input-group input-group-sm mb-0">
                      ...
                      <div class="input-group-append">
                        <button type="submit" class="btn btn-lg button-color">
                    ...
                    <div class="wrapper row">
                      ...
                      <div class="details col-md-6">
                        ...
                        <div class="action">
                          ...
                          <button style={{backgroundColor: '#000099', color: '#ffffff'}} class="like btn btn-default" type="button"><span class="fa fa-comments"></span></button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="row justify-content-centser">
                    <div class="col-12">
                      <div class="text-left">
                        ...
                        <a href="#" class="btn" style={{backgroundColor: '#000099', color: '#ffffff'}}>
                         <i class="fas fa-check"></i> <b>Publier</b>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <ul class="comment-wrap list-unstyled">
                      {/* Comment item START */}
                      <li class="comment-item" style={{backgroundColor:'#ffffff'}}>
                        <div class="d-flex position-relative">
                          {/* Avatar */}
                          <div class="avatar avatar-xs user-block">
                            <a href="#!"><img class="img-circle border-color" src="../../dist/img/user7-128x128.jpg" alt="User Image"/></a>
                          </div>
                          <div class="ms-2">
                            {/* Comment by */}
                            <div class="bg-lght rounded-start-top-0 p-3 rounded">
