                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        {/* Box Comment */}
                                        <div class="card card-widget" style={{ textAlign: 'center' }}>
                                            <div class="card-header">
                                                ...
                                                <div class="card-tools">
                                                    <button class="btn btn-tool button-color" title="Mark as read">
                                ...
                                {/* message */}
                                <div class="card  bg-light p-2 card-outline">
                                    <div class="card-header">
                                        <h3 class="card-title"> <span class="p-2">Ma boîte de messagerie</span></h3>
                                        ...
                                        <li>
                                            <a href="#">
                                                ...
                                                <div class="contacts-list-info text-dark">
                                                    ...
                                                    <span class="contacts-list-msg text-dark">How have you been? I was at atlanta to see if ...</span>
                                                </div>
                                                {/* /.contacts-list-info */}
                                            </a>
                                        </li>
