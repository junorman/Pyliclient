...
const EditStore = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:8002/edit-store/"+id, formData, {
    ...
    //DETAILS USER
    useEffect(() => {
        axios.get("http://localhost:8002/details-store/"+id).then(res => {
        //console.log(res.data.result);
        //console.log("valide: "+res.data.valid);
        //console.log("session: "+res.data.sessionUser.name);
        //console.log("shine: "+res.data.shine);

        setName(res.data.result[0].nom_vm);
        setEmail(res.data.result[0].email_vm);
        setAddress(res.data.result[0].adresse_vm);
        setWebSite(res.data.result[0].siteweb_vm);
        setSlogan(res.data.result[0].slogan);
        setPhone(res.data.result[0].tel_vm);
        setAbout(res.data.result[0].about_vm);
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="card card-default">
                                                    <div className="card-header" style={{ backgroundColor: '#000099', color: '#ffffff' }}>
                                                        <h3 className="card-title"><i className="fa fa-cart-plus"></i> EDITER UN MAGASIN</h3>
