                    ...
                    <div class="col-sm-6">
                            <div class="table-responsive">
                              <table class="table">
                                ...
                                <tr>
                                  <th>Total:</th>
                                  <td style={{fontSize:'larger', fontWeight: 'bold'}}>265.24 €</td>
                                </tr>
                              </table>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center pb-2">
                              ...
                              <div class="form-outline">
                                <input type="password" id="typeText2" class="form-control form-control-lg"
                                  placeholder="&#9679;&#9679;&#9679;" size="2" minlength="3" maxlength="3" />
                                <label class="form-label" for="typeText2">Cvv</label>
                              </div>
                           
                            </div>
                            <button class="btn btn-success mt-4" type="button">Valider</button>
                          </form>
                        </div>
                      </div>
                    </div>
